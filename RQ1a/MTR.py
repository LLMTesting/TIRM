...
for i in sentence1:
    for j in sentence2:
        pattern3 = "Suppose that \"If " + i[:len(
            i) - 1] + ", then " + j + "\" and \"" + j[0] + ' do not' + j[1:] + "\" are true. What is the conclusion? (If there is a conclusion, you only response the conclusion without any analysis. Otherwise, you should only answer \"there is no conclusion\")"
