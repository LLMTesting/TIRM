    ...
    try:
        ...
        if cosine_scores[0][0] < 0.5 and cosine_scores2[0][0] < 0.5 and m < 7:
            try:
                ...
                # correct = 'The conclusion is wrong. Given \"if p, then q\" and \"¬p\" are true, where p and q represent statements, we can not infer whether q is true, so there is no conclusion.\n' + 'You should use this guideline to answer the following questions.'
