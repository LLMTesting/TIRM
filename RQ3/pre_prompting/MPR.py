    ...
    try:
        ...
        if cosine_scores[0][0] < 0.5 and cosine_scores2[0][0] < 0.5 and m < 7:
            try:
                ...
                #correct = 'The conclusion is wrong. Given \"If p, then q\" and \"p\" are true, where p and q represent statements, we can infer that q is true, so the conclusion is that ' + ground_truth[i] + '\n' + 'You should use this guideline to answer the following questions.'
